...
class SignerTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        result = mock_wallet.importmulti([{
            # TODO: use tprv8ZgxMBicQKsPd7Uf69XL1XwhmjHopUGep8GuEiJDZmbQz6o58LninorQAfcKZWARbtRtfnLcJ5MQ2AtHcQJCCRUcMRvmDUjyEmNUWwx8UbK
            #       once private keys can be imported from descriptors
            ...
            "timestamp": "now",
            "range": [0,1],
            "keys": ["cTiN5q13XR9ebmqfXbaCbz2x6C6inEJWqoJ5jP4CCw98ZCJ4gkuN", "cQyvohAKivx5LZstW75zzJXiTsWbwiBP73JzeJpxKVE3vdtXApYR"],
            "internal": False,
            "keypool": True
        },
        {
            ...
            "timestamp": "now",
            "keys": ["cQXi65cAQHEdfoNeWX8jD8dvCbuzAAm2rV1vwQMv63stPD7uiipd"],
            "internal": True,
            "keypool": True
        }])
        ...
        assert_equal(mock_wallet.getwalletinfo()["keypoolsize"], 1)
        dest = self.nodes[0].getnewaddress(address_type='bech32')
        mock_psbt = mock_wallet.walletcreatefundedpsbt([], {dest:0.5}, 0, {"includeWatching": True}, True)['psbt']
