...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case Prune:
            ...
            // prune=0  is the default, prune=1 is set if the user ever enabled and then disabled automatic pruning
    ...
    if(role == Qt::EditRole)
    {
        ...
        case Prune:
            if (value.toBool()) {
              ...
              // TODO: check if pruning actually occurred, otherwise prune=0 is safe too
